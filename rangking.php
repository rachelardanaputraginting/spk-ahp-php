...
<div class="row">
    <div class="col-md-12">
        <ol class="breadcrumb" style="background: transparent; padding:0px;">
            ...
            <li class="text-success" style="font-weight: bold;">Data Rangking</li>
        </ol>
    </div>
    ...
    <div class="col-md-6 text-right">
        <button type="button" onclick="location.href='index.php'" class="btn btn-success"><i class="fa fa-arrow-left"></i> Kembali</button>
    </div>
</div>
